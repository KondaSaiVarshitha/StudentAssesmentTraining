    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span></span>Faculty Mentor<i class="bi bi-chevron-down"></i></a>
            <ul>
...
<li>ID:  <c:out value="${s.id}"></c:out>   </li>
<li>Name: <c:out value="${s.name}"></c:out> </li>
<li>Gender: <c:out value="${s.gender}"></c:out></li>
<li>Department: <c:out value="${s.department}"></c:out></li>
<li>Program: <c:out value="${s.program}"></c:out> </li>
<li>CGPA: <c:out value="${s.cgpa}"></c:out></li>
<li>Email ID: <c:out value="${s.email}"></c:out></li>
<li>Username: <c:out value="${s.username}"></c:out></li>
<li>Contact No: <c:out value="${s.contactno}"></c:out></li>
<li>FacultyMentorId: <c:out value="${s.facultymentorid}"></c:out></li>
<li>TrainerId: <c:out value="${s.trainerid}"></c:out></li>
