...
<td> <c:out value="${s.department}"></c:out>   </td>
<td> <c:out value="${s.program}"></c:out>   </td>
<td> <c:out value="${s.cgpa}"></c:out>   </td>
<td> <c:out value="${s.email}"></c:out>   </td>
<td> <c:out value="${s.username}"></c:out>   </td>
<td> <c:out value="${s.contactno}"></c:out>   </td>
<td> <c:out value="${s.facultymentorid}"></c:out>   </td>
<td> <c:out value="${s.trainerid}"></c:out>   </td>
<td> 

<a href='<c:url value='deleteemp?id=${s.id}'></c:url>'>Delete</a>&nbsp;&nbsp;
<a href='<c:url value='viewstudentprofile?id=${s.id}'></c:url>'>View</a>&nbsp;&nbsp;
