...
<c:forEach items="${mentors}" var="m">

<tr>

<td> <c:out value="${m.id}"></c:out>   </td>
<td> <c:out value="${m.name}"></c:out>   </td>
<td> <c:out value="${m.gender}"></c:out>   </td>
<td> <c:out value="${m.department}"></c:out>   </td>
<td> <c:out value="${m.program}"></c:out>   </td>
<td> <c:out value="${m.designation}"></c:out>   </td>
<td> <c:out value="${m.email}"></c:out>   </td>
<td> <c:out value="${m.username}"></c:out>   </td>
<td> <c:out value="${m.contactno}"></c:out>   </td>
<td> 

<a href='<c:url value='deletementor?id=${m.id}'></c:url>'>Delete</a>&nbsp;&nbsp;
<a href='<c:url value='viewmentorprofile?id=${m.id}'></c:url>'>View</a>&nbsp;&nbsp;
