            ...
            <div class="row">
                <div class="col-md-6">
                    <form:form method="post" action="addstudent" modelAttribute="student">
						...
						<div class="inputbox mt-3"> <span>CGPA</span>
                         <form:input path="cgpa" value="0.00"  class="form-control" required="required" ></form:input> 
                        </div>
                         ...
                         <form:input path="password"  class="form-control" required="required" value="klu"  hidden="true"></form:input> 
                    

                         <form:input path="facultymentorid"  class="form-control" hidden="true" value="-1"></form:input> 
                        
                         <form:input path="trainerid"  class="form-control" hidden="true"  value="-1"></form:input> 
